...
# make sure you are running > FSL 6 (here, v 6.0.4)
# run this script as ~isabel/POADOS/BIDS/code/prepro_DWI_FSL_v03.sh

# Isabel Ellerbrock, 2020

VIA="/data/isabel/POADOS/BIDS"

process(){

for i in ${VIA}/sub-${1}/ses-${2}/dwi/ ; do
  ...
  # run eddy QC for data quality control
